    ...
    render() {
        ...
        return (
            <div className='session-forms-page signin'>
                ...
                <p className='signup-signin'>Already have an account? Sign in here.</p>
            </div>
        )
    }
}
