...
User2 = User.create(username: 'Oscar', email: 'oscar@gmail.com', password: 'starwars')
User3 = User.create(username: 'Otto', email: 'otto@gmail.com', password: 'starwars')
User4 = User.create(username: 'Mia', email: 'mia@gmail.com', password: 'starwars')
User5 = User.create(username: 'Koopa', email: 'koopa@gmail.com', password: 'starwars')
...
joke20.photo.attach(io: open("https://ludicrous-seed.s3.amazonaws.com/ludicrous+seed+pics/degeneres-beginning.jpeg"), filename:"degeneres-beginning.jpg")
 ...
 Comment.create(commentable_id: 0, commentable_type: 'Joke', content: 'This joke is not funny', user_id: User1.id)
 Comment.create(commentable_id: 1, commentable_type: 'Joke', content: 'This joke is kind of funny', user_id: User.first.id)
 Comment.create(commentable_id: 2, commentable_type: 'Joke', content: 'LOL', user_id: User.first.id)
 Comment.create(commentable_id: 3, commentable_type: 'Joke', content: 'this got me ROFL', user_id: User.first.id)
 Comment.create(commentable_id: 4, commentable_type: 'Joke', content: 'man they got jokes', user_id: User.first.id)
 Comment.create(commentable_id: 5, commentable_type: 'Joke', content: 'i cant with this', user_id: User.first.id)
 Comment.create(commentable_id: 6, commentable_type: 'Joke', content: 'best stand up of all time?', user_id: User1.id)
 Comment.create(commentable_id: 7, commentable_type: 'Joke', content: 'Sheesh this person is so funny', user_id: User1.id)
 Comment.create(commentable_id: 8, commentable_type: 'Joke', content: 'I wanna be a standup', user_id: User1.id)
 Comment.create(commentable_id: 9, commentable_type: 'Joke', content: 'this joke too much', user_id: User1.id)
 Comment.create(commentable_id: 10, commentable_type: 'Joke', content: 'this is a comment', user_id: User1.id)
 Comment.create(commentable_id: 11, commentable_type: 'Joke', content: 'is standup professional trolling?', user_id: User1.id)
 Comment.create(commentable_id: 12, commentable_type: 'Joke', content: 'HAHAHAHAH', user_id: User1.id)
 Comment.create(commentable_id: 13, commentable_type: 'Joke', content: 'LMFAOOOOOO', user_id: User1.id)
 Comment.create(commentable_id: 14, commentable_type: 'Joke', content: 'wow I gotta stop commenting on all these', user_id: User1.id)
 Comment.create(commentable_id: 15, commentable_type: 'Joke', content: 'best website ever?', user_id: User1.id)
 Comment.create(commentable_id: 16, commentable_type: 'Joke', content: 'dude this is so funny', user_id: User1.id)
 Comment.create(commentable_id: 17, commentable_type: 'Joke', content: 'the GOAT', user_id: User1.id)
 Comment.create(commentable_id: 18, commentable_type: 'Joke', content: 'comments comments comments', user_id: User1.id)
 Comment.create(commentable_id: 19, commentable_type: 'Joke', content: 'no one in this comments knows anything about comedy', user_id: User1.id)

Comment.create(commentable_id: 0, commentable_type: 'Joke', content: 'This joke is very funny', user_id: User2.id)
 Comment.create(commentable_id: 1, commentable_type: 'Joke', content: 'This joke is definitely funny', user_id: User2.id)
 Comment.create(commentable_id: 2, commentable_type: 'Joke', content: 'Im confused', user_id: User2.id)
 Comment.create(commentable_id: 3, commentable_type: 'Joke', content: 'im weakkkkk', user_id: User2.id)
 Comment.create(commentable_id: 4, commentable_type: 'Joke', content: 'comedic gold', user_id: User2.id)
 Comment.create(commentable_id: 5, commentable_type: 'Joke', content: 'sheesh jokes are funny', user_id: User2.id)
 Comment.create(commentable_id: 6, commentable_type: 'Joke', content: 'worst stand up of all time?', user_id: User2.id)
 Comment.create(commentable_id: 7, commentable_type: 'Joke', content: 'Sheesh this person is SO funny', user_id: User2.id)
 Comment.create(commentable_id: 8, commentable_type: 'Joke', content: 'what a transcript', user_id: User2.id)
 Comment.create(commentable_id: 9, commentable_type: 'Joke', content: 'comedic genius man', user_id: User2.id)
 Comment.create(commentable_id: 10, commentable_type: 'Joke', content: 'this is also a comment', user_id: User2.id)
 Comment.create(commentable_id: 11, commentable_type: 'Joke', content: 'second best career gotta be comedy', user_id: User2.id)
 Comment.create(commentable_id: 12, commentable_type: 'Joke', content: ":,,,,,D", user_id: User2.id)
 Comment.create(commentable_id: 13, commentable_type: 'Joke', content: 'i dont get it', user_id: User2.id)
 Comment.create(commentable_id: 14, commentable_type: 'Joke', content: 'yeah dude i see you every post', user_id: User2.id)
 Comment.create(commentable_id: 15, commentable_type: 'Joke', content: 'what?', user_id: User2.id)
 Comment.create(commentable_id: 16, commentable_type: 'Joke', content:  'i <3 jokes', user_id: User2.id)
 Comment.create(commentable_id: 17, commentable_type: 'Joke', content: 'the undisputable GOAT', user_id: User2.id)
 Comment.create(commentable_id: 18, commentable_type: 'Joke', content: 'more comments comments comments', user_id: User2.id)
 Comment.create(commentable_id: 19, commentable_type: 'Joke', content: '^^ for real only me and connor know comedy', user_id: User2.id)

 Comment.create(commentable_id: 0, commentable_type: 'Joke', content: 'THIS JOKE FUNNY', user_id: User3.id)
 Comment.create(commentable_id: 1, commentable_type: 'Joke', content: 'HAHHAHHAHAHAHAA', user_id: User3.id)
 Comment.create(commentable_id: 2, commentable_type: 'Joke', content: 'THIS IS THE BEST', user_id: User3.id)
 Comment.create(commentable_id: 3, commentable_type: 'Joke', content: 'I get this one', user_id: User3.id)
 Comment.create(commentable_id: 4, commentable_type: 'Joke', content: 'whats a joke', user_id: User3.id)
 Comment.create(commentable_id: 5, commentable_type: 'Joke', content: 'tooo gooood', user_id: User3.id)
 Comment.create(commentable_id: 6, commentable_type: 'Joke', content: 'who is this?', user_id: User3.id)
 Comment.create(commentable_id: 7, commentable_type: 'Joke', content: 'joke make me laugh', user_id: User3.id)
 Comment.create(commentable_id: 8, commentable_type: 'Joke', content: 'jokes are super funny', user_id: User3.id)
 Comment.create(commentable_id: 9, commentable_type: 'Joke', content: 'I dont get this one', user_id: User3.id)
 Comment.create(commentable_id: 10, commentable_type: 'Joke', content: 'LoLoLoLoLoL', user_id: User3.id)
 Comment.create(commentable_id: 11, commentable_type: 'Joke', content: 'i love comedy', user_id: User3.id)
 Comment.create(commentable_id: 12, commentable_type: 'Joke', content: 'laugh out loud', user_id: User3.id)
 Comment.create(commentable_id: 13, commentable_type: 'Joke', content: 'this is gold', user_id: User3.id)
 Comment.create(commentable_id: 14, commentable_type: 'Joke', content: 'this is goooood', user_id: User3.id)
 Comment.create(commentable_id: 15, commentable_type: 'Joke', content: 'best website ever?', user_id: User3.id)
 Comment.create(commentable_id: 16, commentable_type: 'Joke', content: 'who comes up with this', user_id: User3.id)
 Comment.create(commentable_id: 17, commentable_type: 'Joke', content: 'the comedy GOAT', user_id: User3.id)
 Comment.create(commentable_id: 18, commentable_type: 'Joke', content: 'even more comments comments comments', user_id: User3.id)
 Comment.create(commentable_id: 19, commentable_type: 'Joke', content: '^^ dont forget me!', user_id: User3.id)

Comment.create(commentable_id: 0, commentable_type: 'Joke', content: 'follow my standup instagram @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 1, commentable_type: 'Joke', content: 'like comedy? @MiaSpitsJokes on insta', user_id: User4.id)
 Comment.create(commentable_id: 2, commentable_type: 'Joke', content: '@MiaSpitsJokes for best up and coming comedian', user_id: User4.id)
 Comment.create(commentable_id: 3, commentable_type: 'Joke', content: 'follow for follow? @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 4, commentable_type: 'Joke', content: 'next Sarah Silverman -> @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 5, commentable_type: 'Joke', content: '@MiaSpitsJokes @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 6, commentable_type: 'Joke', content: 'next big comedian @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 7, commentable_type: 'Joke', content: '=D @MiaSpitsJokes =D', user_id: User4.id)
 Comment.create(commentable_id: 8, commentable_type: 'Joke', content: 'see me this weekend at the Comedy Club @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 9, commentable_type: 'Joke', content: '@MiaSpitsJokes follllooww meeee', user_id: User4.id)
 Comment.create(commentable_id: 10, commentable_type: 'Joke', content: 'best comedian? its me @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 11, commentable_type: 'Joke', content: 'you love comedy? @MiaSpitsJokes ', user_id: User4.id)
 Comment.create(commentable_id: 12, commentable_type: 'Joke', content: 'laugh out loud @MiaSpitsJokes insta', user_id: User4.id)
 Comment.create(commentable_id: 13, commentable_type: 'Joke', content: 'golden jokes at @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 14, commentable_type: 'Joke', content: 'this is goooood', user_id: User4.id)
 Comment.create(commentable_id: 15, commentable_type: 'Joke', content: 'F4F? @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 16, commentable_type: 'Joke', content: 'need more followers -> @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 17, commentable_type: 'Joke', content: 'the comedy GOAT even better than me but still follow @MiaSpitsJokes', user_id: User4.id)
 Comment.create(commentable_id: 18, commentable_type: 'Joke', content: 'adding comments comments comments', user_id: User4.id)
 Comment.create(commentable_id: 19, commentable_type: 'Joke', content: '@MiaSpitsJokes is the omnipotent jokester', user_id: User4.id)

 Comment.create(commentable_id: 0, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 1, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 2, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 3, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 4, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 5, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 6, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 7, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 8, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 9, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 10, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 11, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 12, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 13, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 14, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 15, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 16, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 17, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 18, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
 Comment.create(commentable_id: 19, commentable_type: 'Joke', content: 'ha.', user_id: User5.id)
